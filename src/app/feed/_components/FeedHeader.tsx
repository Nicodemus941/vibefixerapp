      ...
      <div className="mx-auto max-w-2xl px-3 sm:px-6 h-14 flex items-center justify-between gap-2">
        ...
        <nav className="flex items-center gap-1 sm:gap-2" aria-label="Primary">
          ...
          <HeaderIconLink href="/matches" label="Matches">
            ...
            <span className="hidden md:inline text-xs">Matches</span>
          </HeaderIconLink>
          <HeaderIconLink href="/inbox" label="Inbox">
            <Inbox className="h-4 w-4" />
            <span className="hidden md:inline text-xs">Inbox</span>
          </HeaderIconLink>
          <HeaderIconLink href="/groups" label="Groups" className="hidden sm:inline-flex">
